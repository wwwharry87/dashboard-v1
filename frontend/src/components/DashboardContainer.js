// components/DashboardContainer.js
import React, { useState, useEffect } from 'react';
import Dashboard from './Dashboard'; // Componente que exibe os dados do dashboard

const DashboardContainer = ({ loginData }) => {
  ...
  return (
    <div>
      ...
      <div>
        ...
        <select value={selectedCliente ? selectedCliente.idcliente : ''} onChange={handleChangeCliente}>
